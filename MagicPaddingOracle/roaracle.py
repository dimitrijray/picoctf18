...
cookie = 'f7ee59558d62d81db804a3b8ce1c557'
...
for block_no in range(no_of_blocks):
	...
	plaintext_block = [decrypted_chain[i] ^ previous_block[i] for i in range(len(decrypted_chain))]
	...
	previous_block = cipherblock_array
#print(plaintext)